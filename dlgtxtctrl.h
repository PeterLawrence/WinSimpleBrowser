...
public:
    ...
    bool NewLine();
    bool Clear();
    bool GetSelectedText(int &aStartPos,int &aEndPos);

    bool GetTextFormat(CHARFORMAT &aFormat);
    bool BoldText(bool TurnOn=true);
    bool UnderlineText(bool TurnOn=true);
    bool StrikeText(bool TurnOn=true);
    bool ItalicText(bool TurnOn=true);
    bool SizeText(bool LargerText);
    bool ColourText(COLORREF aTextColour);
};
#endif